...
(defun color-theme-zen-and-art ()
  ...
  (color-theme-install
    '(color-theme-zen-and-art
      ...
      (font-lock-type-face  ((t (:italic t :foreground "#C6B032" :slant italic))))
...
(provide 'color-theme-zen-and-art)
