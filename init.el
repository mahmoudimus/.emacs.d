...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Mahmoudimus Iosevka v2" ;;"Rec Mono Linear"
                               :size 13
                               :weight normal
                               :width: normal
                               :powerline-scale 1.0
   ...
   ;; use spacelpa instead
   ;; https://www.reddit.com/r/spacemacs/comments/7yvbqz/is_it_worth_to_use_develop_branch_instead_of/dujw8ca/
